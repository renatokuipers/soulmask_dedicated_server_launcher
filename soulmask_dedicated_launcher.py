...
[Dedicated.Settings]
SteamServerName=DivineGamingNL
MaxPlayers=4
pvp=False
backup=900
saving=600
...
def create_config_files(server_dir=DEFAULT_SERVER_DIR, steam_server_name="UNNAMED_SERVER", max_players=20, pvp=False):
...
def setup_game_server(steam_server_name="UNNAMED_SERVER", max_players=20, pvp=False):
...
# Create fields for server management settings
ttk.Label(server_management_frame, text="Executable Name:").grid(row=0, column=0, padx=10, pady=10)
ttk.Entry(server_management_frame, textvariable=executable_name_var).grid(row=0, column=1, padx=10, pady=10)

ttk.Label(server_management_frame, text="Map Name:").grid(row=1, column=0, padx=10, pady=10)
ttk.Entry(server_management_frame, textvariable=map_name_var).grid(row=1, column=1, padx=10, pady=10)

ttk.Label(server_management_frame, text="Steam Server Name:").grid(row=2, column=0, padx=10, pady=10)
ttk.Entry(server_management_frame, textvariable=steam_server_name_var).grid(row=2, column=1, padx=10, pady=10)

ttk.Label(server_management_frame, text="Max Players:").grid(row=3, column=0, padx=10, pady=10)
ttk.Entry(server_management_frame, textvariable=max_players_var).grid(row=3, column=1, padx=10, pady=10)

ttk.Label(server_management_frame, text="Password:").grid(row=4, column=0, padx=10, pady=10)
ttk.Entry(server_management_frame, textvariable=password_var, show='*').grid(row=4, column=1, padx=10, pady=10)

ttk.Label(server_management_frame, text="Admin Password:").grid(row=5, column=0, padx=10, pady=10)
ttk.Entry(server_management_frame, textvariable=admin_password_var, show='*').grid(row=5, column=1, padx=10, pady=10)

# Create additional fields for server management settings from ini file
ttk.Label(server_management_frame, text="Port:").grid(row=6, column=0, padx=10, pady=10)
ttk.Entry(server_management_frame, textvariable=port_var).grid(row=6, column=1, padx=10, pady=10)

ttk.Label(server_management_frame, text="PVP:").grid(row=7, column=0, padx=10, pady=10)
ttk.Checkbutton(server_management_frame, variable=pvp_var, onvalue=True, offvalue=False).grid(row=7, column=1, padx=10, pady=10)

ttk.Label(server_management_frame, text="Backup (seconds):").grid(row=8, column=0, padx=10, pady=10)
ttk.Entry(server_management_frame, textvariable=backup_var).grid(row=8, column=1, padx=10, pady=10)

ttk.Label(server_management_frame, text="Saving (seconds):").grid(row=9, column=0, padx=10, pady=10)
ttk.Entry(server_management_frame, textvariable=saving_var).grid(row=9, column=1, padx=10, pady=10)

# Buttons to start and stop server
ttk.Button(server_management_frame, text="Start Server", command=start_server).grid(row=10, column=0, padx=10, pady=10)
ttk.Button(server_management_frame, text="Stop Server", command=stop_server).grid(row=10, column=1, padx=10, pady=10)

# Server status display
server_status_var = tk.StringVar(value="Stopped")
ttk.Label(server_management_frame, text="Server Status:").grid(row=11, column=0, padx=10, pady=10)
server_status_label = ttk.Label(server_management_frame, textvariable=server_status_var, foreground="red")
server_status_label.grid(row=11, column=1, padx=10, pady=10)

# Placeholder button for saving server management settings
ttk.Button(server_management_frame, text="Save Server Settings", command=save_ini_config).grid(row=12, column=0, columnspan=2, pady=20)
